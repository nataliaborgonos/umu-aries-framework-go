...
sed -i 's#grpcs://localhost:7051#grpcs://peer0.org1.example.com:7052#g' $CONNECTION_PROFILE_PATH
sed -i 's#https://localhost:7054#https://ca.org1.example.com:7055#g' $CONNECTION_PROFILE_PATH
