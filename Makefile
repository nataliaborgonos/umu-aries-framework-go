...
CONNECTION_PROFILE_PATH=/home/natalia/umu-aries-framework-go/test/bdd/fixtures/agent-rest/data/connection-profile.json
...
run-openapi-demo: stop-openapi-demo run-fabric generate-test-keys generate-dpabc-clib generate-openapi-demo-specs
...
agent-rest:
	...
	@mkdir -p ./build/bin
	@cd ${ARIES_AGENT_REST_PATH} && go mod tidy &&  go build -o ../../build/bin/aries-agent-rest main.go
